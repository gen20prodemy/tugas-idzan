...
public class AsyncService {
    ...
    public void processSave(CategoryDTO categoryDTO) throws InterruptedException {
        log.info("initiate payment for order " + categoryDTO.getName());
        //call actual payment gateway
        Thread.sleep(2000);
        log.info("completed payment for order " + categoryDTO.getName());
    }
    @Async
